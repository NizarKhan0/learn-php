...
if($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
  ...
  //insert to db sama je mcam msql statement
        ...
        <div class="bg-white p-8 rounded shadow-md w-full max-w-md">
            ...
            <form method="post">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="body" name="body" placeholder="Enter post body"
                        class="w-full px-4 py-2 border rounded focus:ring focus:ring-blue-300 focus:outline-none"></textarea>
                </div>
