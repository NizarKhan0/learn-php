                ...
                <div class="p-4">
                    ...
                    <ul class="mt-4">
                        ...
                        <li class="mb-2">
                            ...
                            <!-- guna ternary operator -->
                            <?php echo $job['location'] === 'New York' ? '<span class="text-xs text-white bg-blue-500 rounded-full px-2 py-1 ml-2">Local</span>' :
                             '<span class="text-xs text-white bg-green-500 rounded-full px-2 py-1 ml-2">Remote</span>'; ?>

                        </li>

                        <!-- guna ternary operator -->
                        <?php echo !empty($job['tags']) ? '<li class="mb-2"><strong>Tags:</strong> ' . implode(', ', $job['tags']) . '</li>' : ''; ?>
