...
function calculateAverageSalary($listings)
{
  ...
  //$listing  ni dah declare kat  atas tu list job
...
//check if location query string is there nak check ada location = ? atau tak klau takde dia listkan semua job listing
