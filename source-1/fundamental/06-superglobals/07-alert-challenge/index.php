...
$description = '';
$submitted = false;
//guna array utk looping messages
$messages = [];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit'])) {
  ...
  if (!isset($_FILES['logo']) || $_FILES['logo']['error'] === UPLOAD_ERR_NO_FILE) {
    $messages[] = ['text' => 'Please upload a file', 'color' => 'text-red-500'];
  } else {
    if ($file['error'] === UPLOAD_ERR_OK) {
      ...
      if (in_array($fileExtension, $allowedExtensions)) {
        ...
        $messages[] = ['text' => 'Invalid file type, file must be jpg, jpeg, or png', 'color' => 'text-red-500'];
      }
    }
  }

  //cek utk kalau ada file image tu submitted = true kalau tak dia false sebab by default dah false
  var_dump($submitted);
}
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="description" name="description" placeholder="Enter job description"
                        class="w-full px-4 py-2 border rounded focus:ring focus:ring-blue-300 focus:outline-none"><?= $description ?></textarea>
                </div>
                <div class="mb-4">
